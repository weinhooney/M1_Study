...
public class GameScene : BaseScene
{
    public override bool Init()
    {
        ...
        {
            // Managers.Object.Spawn<Monster>(new Vector3(0, 1, 0), Define.MONSTER_BEAR_ID);
            // Managers.Object.Spawn<Monster>(new Vector3(1, 1, 0), Define.MONSTER_SLIME_ID);
            // Managers.Object.Spawn<Monster>(new Vector3(2, 1, 0), Define.MONSTER_GOBLIN_ARCHER_ID);
            // Managers.Object.Spawn<Monster>(new Vector3(3, 1, 0), Define.MONSTER_GOBLIN_ARCHER_ID);
        }
