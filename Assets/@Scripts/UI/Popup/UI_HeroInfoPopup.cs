...
public class UI_HeroInfoPopup : UI_Popup
{
    ...
    private int _heroDataId = -1;
    HeroSaveData SaveData
    {
        get { return Managers.Game.AllHeroes.Find(h => h.DataId == _heroDataId); }
    }
    ...
    void Refresh()
    {
        ...
        Data.HeroData data = Managers.Data.HeroDict[_heroDataId];
