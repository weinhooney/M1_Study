...
public class UI_HeroesListPopup : UI_Popup
{
    ...
    private List<UI_HeroesList_HeroItem> _equippedHeroes = new List<UI_HeroesList_HeroItem>();
    private List<UI_HeroesList_HeroItem> _waitingHeroes = new List<UI_HeroesList_HeroItem>();
    private List<UI_HeroesList_HeroItem> _unownedHeroes = new List<UI_HeroesList_HeroItem>();
